...
public class AddProduct extends AppCompatActivity {
    ...
    private void saveProduct(View view) {
        ...
        String stPrice = (edtPrice.getText().toString().trim());
        String stQuantity = (edtQuantity.getText().toString().trim());
        String description = edtDescription.getText().toString().trim();
        String image = edtImage.getText().toString().trim();
        if (name.equals("") || stPrice.equals("") || stQuantity.equals("") ||
                description.equals("") || image.equals("")
        ) {
            showMessage(AddProduct.this, "Bạn chưa điền đủ thông tin");
        } else {
